...
router.get(  '/account',               ev(pv.account.index),          ctrl.auth.authenticate, ctrl.account.index);
router.patch('/account',               ev(pv.account.update),         ctrl.auth.authenticate, ctrl.account.update);
router.post( '/account/password',      ev(pv.account.updatePassword), ctrl.auth.authenticate, ctrl.account.updatePassword);
router.post( '/account/email',         ev(pv.account.updateEmail),    ctrl.auth.authenticate, ctrl.account.updateEmail);
